...
public class FileUploadRequest implements ProtocolMessage {
    ...
    /**
     * Decodes a {@link ByteBuf} message into a {@link FileUploadRequest}.
     *
     * @param message the {@link ByteBuf} containing the encoded request
     * @return the decoded {@link FileUploadRequest}
     */
    ...
    /**
     * Encodes the {@link FileUploadRequest} into a {@link ByteBuf}.
     *
